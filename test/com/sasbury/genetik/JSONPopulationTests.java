...
public class JSONPopulationTests extends TestCase
{
    ...
    public void runTest(Properties props) throws Exception
    {
        ...
        File f = new File("/tmp/poptest.json");
        f.delete();
        ...
        Population pop2 = JSONPopulationCoder.decode(new File("/tmp/poptest.json"),run);
