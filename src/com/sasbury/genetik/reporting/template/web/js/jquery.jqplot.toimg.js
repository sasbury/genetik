...
/*
 * To image library - Stephen Asbury - sasbury.com
 */

function convertFlotToImage(targetId)//based on code from lessaworld.com
{
    var divobj = $(targetId);
    var oImg = Canvas2Image.saveAsPNG(divobj.children().get(0), true);
